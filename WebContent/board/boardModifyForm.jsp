<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    try{
    	...
    	conn = DriverManager.getConnection("jdbc:mysql://localHost:3306/stone3", "root", "158774");
...
<body>
	...
	<p>
		<input type="button" value="목록" onclick="goUrl('boardList.jsp?pageNum=<%=pageNum %>&amp;searhType=<%=searchType %>&amp;searchText=<%=searchText %>');" />
